...
import { X } from "lucide-react"; // nice close icon (you can install lucide-react if not already)
    ...
    <div className="fixed bottom-5 left-1/2 transform -translate-x-1/2 max-w-md w-[90%] bg-white border border-gray-200 shadow-xl rounded-2xl p-5 z-50 flex flex-col gap-3">
      ...
      <div className="flex justify-center gap-3 mt-2">
        ...
        <button
          ...
          className="px-4 py-2 text-sm text-white transition bg-[#2f1991] rounded-lg hover:bg-purple-600 cursor-pointer"
        >
          Accept
        </button>
      </div>
