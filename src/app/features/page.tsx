  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="SmatPay Features: Payments, Subscriptions & More" />
        <meta property="og:description" content="Explore SmatPay's core features, including multiple payment options, recurring billing, tokenization, and developer-friendly APIs to streamline your business's payments." />
