  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore SmatPay's powerful features, including multiple payment options, recurring billing, smart POS terminals, and developer tools to grow your business in Africa."
        />
      </Head>
      ...
      <div className="bg-white">
        ...
        <div className="relative w-full h-[500px] md:h-[650px] flex items-center justify-center text-center overflow-hidden group">
          <div className="absolute inset-0 z-0 transition-transform duration-1000 ease-in-out group-hover:scale-105">
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-blue-900/60"></div>
          </div>
          <motion.div
        ...
        <section className="relative py-16 bg-white">
          <div className="container px-6 mx-auto text-center max-w-7xl">
            <h2 className="text-2xl font-bold text-[#2f1991] sm:text-3xl mb-8">
              Accept All Major Payment Methods
            </h2>
            <div className="mt-10 overflow-hidden border border-gray-200 rounded-3xl bg-purple-50">
